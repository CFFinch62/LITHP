...
|-------|-------------|--------|---------|
| **Phase 1** | **Project Foundation**<br>Initialized directory structure, main entry points, `MainWindow` skeleton, and configuration management. | ✅ Complete | [View Log](CHANGELOG-Phase1.md) |
| **Phase 2** | **Code Editor**<br>Implemented syntax highlighting, parenthesis matching, line numbers, and tabbed file interface. | ✅ Complete | [View Log](CHANGELOG-Phase2.md) |
